...
data_dir=data-bin/iwslt16_de-en/bin
save_path=model/iwslt16_ctc
...
python3 train.py ${data_dir} --arch glat_ctc --noise full_mask --share-all-embeddings \
    ...
    --lr-scheduler ${lr_scheduler}  --init-lr 3e-4 --warmup-updates 4000 --optimizer adam --adam-betas '(0.9, 0.999)' \
